...
import (
	...
	pb_testproto "github.com/gospotcheck/go-grpc-middleware/testing/testproto"

	grpc_middleware "github.com/gospotcheck/go-grpc-middleware"
	grpc_retry "github.com/gospotcheck/go-grpc-middleware/retry"
	"github.com/gospotcheck/go-grpc-middleware/testing"
...
func (s *RetrySuite) TestCallOptionsDontPanicWithoutInterceptor() {
	// Fix for https://github.com/gospotcheck/go-grpc-middleware/issues/37
